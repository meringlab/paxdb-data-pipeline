...
datasetNames <- c(commandArgs(trailingOnly = T)[3], commandArgs(trailingOnly = T)[4], commandArgs(trailingOnly = T)[5], commandArgs(trailingOnly = T)[6], commandArgs(trailingOnly = T)[7], commandArgs(trailingOnly = T)[8], commandArgs(trailingOnly = T)[9], commandArgs(trailingOnly = T)[10])#'Spombe_Alex_2012_09_spectral_count')
